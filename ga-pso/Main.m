...
Demand=xlsread('data','Demand');%需求矩阵
Travelcon=xlsread('data','Travelcon');%距离限制
Capacity=xlsread('data','Capacity');%运量限制
TravelTime=xlsread('data','TravelTime');%旅行时间矩阵
TimeWindow=xlsread('data','TimeWindow');%时间窗
Distance=xlsread('data','Distance');%距离矩阵
